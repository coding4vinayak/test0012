...
app.use(session({
  secret: process.env.SESSION_SECRET || 'ai-personality-tweets-secret-key',
  resave: false,
...
if (process.env.NODE_ENV !== 'test') {
  server = app.listen(PORT, () => {
    console.log(`AI Personality from Tweets running on http://localhost:${PORT}`);
  });
}
